...
public class Dashboard extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(Dashboard.this).load(url).into(image_profile);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_attendance) {
            ...
            Intent intent3 = new Intent(Dashboard.this,TimeTable.class);
            startActivity(intent3);
            finish();

        } else if (id == R.id.nav_grades) {
            Intent intent4 = new Intent(Dashboard.this,Grades.class);
            startActivity(intent4);
            finish();

        } else if(id == R.id.nav_exam){
            Intent intent5 = new Intent(Dashboard.this,Examinations.class);
            startActivity(intent5);
            finish();

        } else if (id == R.id.nav_teacher){
            Intent intent7 = new Intent(Dashboard.this,Teacher.class);
            startActivity(intent7);
            finish();

        } else if (id == R.id.nav_holidays){
            Intent intent8 = new Intent(Dashboard.this,EventHolidays.class);
